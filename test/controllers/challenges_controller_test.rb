...
class ChallengesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create challenge" do
    assert_difference('Challenge.count') do
      post challenges_url, params: { challenge: { category_id: @challenge.category_id, challenge: @challenge.challenge } }
    end
  ...
  test "should update challenge" do
    patch challenge_url(@challenge), params: { challenge: { category_id: @challenge.category_id, challenge: @challenge.challenge } }
